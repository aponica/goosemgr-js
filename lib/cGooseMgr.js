...
class cGooseMgr {
  ...
  //
  //  @param {Class} cGoose
  //    The class of the "Goose" being managed.
  //---------------------------------------------------------------------------

  constructor( hDefinitions, cGoose ) {
  ...
  //    as an `async` function so {@linkcode
  //      module:@aponica/goosemgr-js.cGooseMgr#fiConnect|xGooseMgr.fiConnect}
  //    can be called from outside of an `async` function.
  //---------------------------------------------------------------------------

  fiCreateConnection( vConfig ) {
  ...
  fiConnect( vConfig ) {
    return new Promise( ( fResolve, fReject ) =>
      this.fiCreateConnection( vConfig ).then( // connection promised
        iConnection => {
